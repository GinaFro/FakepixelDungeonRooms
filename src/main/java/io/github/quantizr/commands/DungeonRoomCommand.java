            ...
            if (arg1.length < 1) {
                if (!Utils.inDungeons) {
                    player.addChatMessage(new ChatComponentText(EnumChatFormatting.RED
                            + "FDR: Use this command in dungeons or run \"/room help\" for additional options"));
                    return;
                }
                ...
                if (blockFrequencies == null) {
                    player.addChatMessage(new ChatComponentText(EnumChatFormatting.RED
                            + "FDR: Make sure you aren't in a hallway between rooms and that your render distance is high enough."));
                    return;
                }
                ...
                switch (arg1[0].toLowerCase()) {
                    case "help":
                        player.addChatMessage(new ChatComponentText(
                                "\n" + EnumChatFormatting.GOLD + "FakepixelDungeonRooms Mod Version " + DungeonRooms.VERSION + "\n" +
                    ...
                    case "open":
                        if (!Utils.inDungeons) {
                            player.addChatMessage(new ChatComponentText(EnumChatFormatting.RED
                                    + "FDR: Use this command in dungeons"));
                            return;
                        }
                    ...
                    case "set":
                        switch (arg1[1].toLowerCase()) {
                            ...
                            default:
                                player.addChatMessage(new ChatComponentText(EnumChatFormatting.RED
                                        + "FDR: Valid options are <gui | dsg | sbp>"));
                                break;
                        }
                        break;
                    ...
                    case "toggle":
                        String toggleHelp = "\n" + EnumChatFormatting.GOLD + " FakepixelDungeonRooms Mod Toggle Commands:" + "\n" +
                    ...
                    case "discord":
                        try {
                            player.addChatMessage(new ChatComponentText("FDR: Opening Fakepixel Discord invite in browser..."));
                    ...
                    case "coord":
                        if(Utils.originBlock == null) {
                            DungeonRooms.logger.warn("FDR: originBlock is null");
                            return;
                        }
                    ...
                    case "add":
                        ...
                        switch (arg1[1].toLowerCase()) {
                            ...
                            default:
                                player.addChatMessage(new ChatComponentText(EnumChatFormatting.RED
                                        + "FDR: Valid options are <chest | wither | superboom | lever | fairysoul | item | entrance | bat>"));
                                break;
                        }
                        break;
                    default:
                        player.addChatMessage(new ChatComponentText(EnumChatFormatting.RED
                                + "FDR: Run \"/room\" by itself to see the room name or run \"/room help\" for additional options"));
                }
            }
        }).start();
    }
