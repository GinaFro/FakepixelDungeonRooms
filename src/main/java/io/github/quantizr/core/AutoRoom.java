...
public class AutoRoom {
    ...
    public void onWorldChange(WorldEvent.Load event) {
        ...
        if (output.isEmpty()) {
            output.add("FDR: " + EnumChatFormatting.GREEN+ "Press the hotkey \"" + GameSettings.getKeyDisplayString(DungeonRooms.keyBindings[1].getKeyCode()) +"\" to configure");
    ...
    public static List<String> autoText() {
        ...
        String text = "FDR: You are in " + EnumChatFormatting.GREEN;
