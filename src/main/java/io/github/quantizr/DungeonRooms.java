...
{
    public static final String MODID = "FDR";
    ...
    public void init(FMLInitializationEvent event) {
        ...
        keyBindings[0] = new KeyBinding("Open Room Images in DSG/SBP", Keyboard.KEY_O, "FakepixelDungeonRooms Mod");
        keyBindings[1] = new KeyBinding("Open Waypoint Menu", Keyboard.KEY_P, "FakepixelDungeonRooms Mod");
    ...
    public void postInit(final FMLPostInitializationEvent event) {
        ...
        DungeonRooms.logger.info("FDR: SBP Dungeon Secrets detection: " + usingSBPSecrets);
    }
    ...
    */
    ...
    public void onJoin(EntityJoinWorldEvent event) {
        ...
        if (!updateChecked) {
            ...
            new Thread(() -> {
                try {
                    DungeonRooms.logger.info("FDR: Checking for updates...");
                    ...
                    if (currentVersion.compareTo(latestVersion) < 0) {
                        ...
                        player.addChatMessage(new ChatComponentText(EnumChatFormatting.RED + "FakepixelDungeonRooms Mod is outdated. Please update to " + latestTag + ".\n").appendSibling(update));
                    }
                } catch (IOException e) {
        ...
        if (keyBindings[0].isPressed()) {
            if (!Utils.inDungeons) {
                player.addChatMessage(new ChatComponentText(EnumChatFormatting.RED
                        + "FDR: Use this hotkey in dungeons"));
                return;
            }
            switch (hotkeyOpen) {
                case "gui":
                ...
                default:
                    player.addChatMessage(new ChatComponentText(EnumChatFormatting.RED
                            + "FDR: hotkeyOpen config value improperly set, do \"/room set <gui | dsg | sbp>\" to change the value"));
                    break;
            }
        }
